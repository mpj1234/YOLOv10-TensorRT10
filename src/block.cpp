...
nvinfer1::ILayer *convBn(nvinfer1::INetworkDefinition *network,
                         std::map<std::string, nvinfer1::Weights> weightMap, nvinfer1::ITensor &input,
...
nvinfer1::ILayer *bottleneck(nvinfer1::INetworkDefinition *network, std::map<std::string, nvinfer1::Weights> weightMap,
    ...
    nvinfer1::IElementWiseLayer *conv2 =
            convBnSiLU(network, weightMap, *conv1->getOutput(0), c2, 3, 1, lname + ".cv2");
...
nvinfer1::IElementWiseLayer *C2F(nvinfer1::INetworkDefinition *network,
    ...
    nvinfer1::IElementWiseLayer *conv2 =
            convBnSiLU(network, weightMap, *cat->getOutput(0), c2, 1, 1, lname + ".cv2");
...
nvinfer1::ILayer *SCDown(nvinfer1::INetworkDefinition *network,
    ...
    nvinfer1::IConvolutionLayer *conv2 =
            network->addConvolutionNd(*conv1->getOutput(0), ch, nvinfer1::DimsHW{k, k},
...
nvinfer1::ILayer *Attention(nvinfer1::INetworkDefinition *network,
                            std::map<std::string, nvinfer1::Weights> weightMap, nvinfer1::ITensor &input,
...
nvinfer1::ILayer *RepVGGDW(nvinfer1::INetworkDefinition *network, std::map<std::string, nvinfer1::Weights> weightMap,
    ...
    auto ew_silu = network->addElementWise(*ew->getOutput(0), *sigmoid->getOutput(0),
